...
void switch_buffer(DMA_DoubleBuffer_t *dma_doublebuffer)
{
  ...
  uint8_t active_buffer = dma_doublebuffer->active_buffer;
  ...
  dma_doublebuffer->active_buffer = active_buffer;
...
void HAL_TIM_PWM_PulseFinishedHalfCpltCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == TIM3)
  {
    ...
    printf("HAL_TIM_PWM_PulseFinishedHalfCpltCallback-tim3\r\n");
...
void HAL_TIM_OC_DelayElapsedCallback(TIM_HandleTypeDef *htim)
{
  if (htim->Instance == TIM3)
  {
    ...
    __HAL_TIM_SET_COMPARE(htim, TIM_CHANNEL_1, cnt + 1200);
  }
}
