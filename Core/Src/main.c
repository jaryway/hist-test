...
int main(void)
{
  ...
  Stepper_init(&stepper86, 0);
  Stepper_attach(&stepper86, ENA_PORT, ENA_PIN, PUL_PORT, PUL_PIN, DIR_PORT, DIR_PIN);
  Stepper_attach_timer(&stepper86, &htim3, MOTOR86_PWM_TIMER_CHANNEL);
  Stepper_set_steps_per_mm(&stepper86, (uint16_t)MOTOR86_STEPS_PER_MM);
